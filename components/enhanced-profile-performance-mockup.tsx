        ...
        >
          ...
          <div className="relative w-[280px] h-[600px] rounded-[3rem] bg-black/50 backdrop-blur-xl border border-white/20 shadow-2xl p-3 overflow-hidden">
            ...
            <div className="w-full h-full rounded-[2.5rem] bg-gradient-to-b from-slate-900 to-slate-800 overflow-hidden relative">
              ...
              {/* Profile header */}
              <div className="absolute top-6 left-3 right-3 z-20">
                <div className="flex items-center gap-3 mb-4">
                  <motion.div
                    className="w-16 h-16 rounded-full bg-gradient-to-br from-slate-600 to-slate-800 flex items-center justify-center border-3 border-white/20 shadow-2xl"
                  ...
                  <div className="flex-1">
                    <h2 className="text-white text-base font-bold">tytus luke</h2>
                    <p className="text-white/70 text-xs">@daleebling9</p>
                  </div>
                </div>
                ...
                <div className="flex gap-1.5 mb-4">
                  {[
                    ...
                    <motion.button
                      key={index}
                      className={`flex-1 bg-gradient-to-r ${action.color} text-white font-semibold py-1.5 px-1.5 rounded-lg flex items-center justify-center gap-0.5 shadow-lg`}
                      initial={{ opacity: 0, y: 20 }}
                      whileInView={{ opacity: 1, y: 0 }}
                      viewport={{ once: true }}
              ...
              {/* Performance section */}
              <motion.div
                className="absolute top-36 left-3 right-3 bottom-3"
              ...
              >
                <div className="backdrop-blur-xl bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-2xl border border-emerald-500/30 p-3 shadow-2xl h-full">
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <div>
                      <h3 className="text-white text-sm font-bold">Performance</h3>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="text-white/70 text-[10px]">matches played</div>
                  </div>
                      ...
                      >
                        <div className="relative w-12 h-12 mb-1.5">
                          ...
                          <div className="absolute inset-1.5 rounded-full bg-slate-800 flex items-center justify-center">
                            <span className="text-white text-[9px] font-bold">{stat.value}</span>
                          </div>
                        </div>
                        <div className="text-white/70 text-[9px]">{stat.label}</div>
                      </motion.div>
                    ))}
                  </div>
                  ...
                  <div className="flex gap-2">
                    {weeklyStats.map((stat, index) => (
                      <motion.div
                        key={index}
                        className="flex-1 backdrop-blur-lg bg-white/10 rounded-xl border border-white/20 p-2 text-center"
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                      ...
                      >
                        ...
                        <div className="text-white text-base font-bold mb-0.5">{stat.value}</div>
                        <div className="text-white/70 text-[8px]">{stat.label}</div>
                      </motion.div>
                    ))}
                  </div>
