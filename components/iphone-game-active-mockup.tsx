    ...
    <div className="relative w-full flex items-center justify-center">
      ...
      >
        ...
        >
          ...
          <div className="relative w-[200px] h-[260px] sm:w-[240px] sm:h-[280px] md:w-[260px] md:h-[300px] lg:w-[280px] lg:h-[320px] rounded-t-xl sm:rounded-t-2xl lg:rounded-t-[2rem] bg-black/50 backdrop-blur-xl border border-white/20 border-b-0 shadow-2xl p-2 lg:p-3 overflow-hidden">
            {/* Inner screen */}
            <div className="w-full h-full rounded-t-xl sm:rounded-t-2xl lg:rounded-t-[2rem] bg-gradient-to-b from-slate-900 to-slate-800 overflow-hidden relative">
              {/* Status bar */}
            ...
            {/* Phone notch */}
            <div className="absolute top-2 sm:top-3 left-1/2 -translate-x-1/2 w-20 sm:w-24 lg:w-28 h-4 sm:h-5 lg:h-6 bg-black rounded-full z-30 shadow-xl" />
          </div>
