...
export function HeroSection() {
  return (
    <section className="relative pt-4 pb-2 sm:pt-20 sm:pb-12 px-2 lg:px-12 overflow-hidden min-h-screen flex items-start sm:items-center lg:items-end">
      {/* Background image */}
      <div
      ...
      <div className="relative z-10 w-full pb-2 sm:pb-8 mt-16 sm:mt-0">
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-end">
          <div className="space-y-2 sm:space-y-4 flex flex-col justify-start sm:justify-end items-center lg:items-start text-center lg:text-left order-2 lg:order-1">
            <motion.h1 
            ...
            >
              ...
              <br />
              <motion.span
                className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl inline-block"
                style={{ 
                  color: 'white',
                  willChange: 'transform',
                  backfaceVisibility: 'hidden',
            ...
            <motion.p 
              className="text-sm sm:text-base lg:text-lg text-white max-w-md text-pretty px-4 lg:px-0"
            ...
            <motion.div 
              className="flex flex-wrap gap-2 sm:gap-3 justify-center lg:justify-start px-2 lg:px-0"
              style={{ willChange: 'transform, opacity', backfaceVisibility: 'hidden' }}
              initial={{ opacity: 0, y: 20 }}
              animate={{ 
                opacity: 1,
            ...
            >
              <a href="#" className="inline-block">
                <motion.div 
                  className="bg-card border border-border rounded-lg px-3 sm:px-4 py-1.5 sm:py-2 flex items-center gap-2 hover:bg-card/80 transition-colors"
            ...
            <motion.div 
              className="flex items-center gap-3 sm:gap-4 pt-1 sm:pt-2 justify-center lg:justify-start"
              style={{ willChange: 'transform, opacity', backfaceVisibility: 'hidden' }}
              initial={{ opacity: 0, y: 20 }}
              animate={{ 
                opacity: 1,
            ...
            >
              <div className="flex -space-x-2 scale-90 sm:scale-100">
                {[
                  ...
                  <motion.div
                    key={i}
                    className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 border-background overflow-hidden"
              ...
              <div className="text-sm sm:text-base">
                <div className="flex items-center gap-1">
                  ...
                  <motion.span 
                    className="ml-1 font-semibold text-xs sm:text-sm"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ delay: 1 }}
                  >
