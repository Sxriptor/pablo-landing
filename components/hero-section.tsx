...
export function HeroSection() {
  return (
    <section className="relative pt-24 pb-16 px-4 md:px-20 min-h-screen flex flex-col md:flex-row md:items-end items-center justify-center md:justify-start">
      ...
      <div className="relative md:absolute scale-[0.55] sm:scale-[0.65] md:scale-125 md:right-80 md:top-1/2 md:-translate-y-1/2 z-20 top-0 mt-1 md:mt-0">
        <PhoneMockupTriple />
      </div>
        ...
        <div className="w-full max-w-2xl flex flex-col items-center md:items-start justify-start gap-0.5 md:gap-2">
          ...
          <div className="space-y-0.5 md:space-y-2 flex flex-col items-center md:items-start text-center md:text-left order-2 lg:order-1 max-w-full flex-shrink-0">
            ...
            >
              ...
              <br />
              <motion.span
                className="block text-3xl md:text-[4rem]"
                style={{ 
                  color: 'white',
                  willChange: 'transform',
                  backfaceVisibility: 'hidden',
