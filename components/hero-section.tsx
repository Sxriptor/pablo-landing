    ...
    <section className="relative pt-20 pb-12 px-2 lg:px-12 overflow-hidden h-screen">
      ...
      <div className="relative z-10 h-full">
        <div className="grid lg:grid-cols-2 gap-12 items-end h-full">
          <div className="space-y-4 flex flex-col justify-end items-center lg:items-start text-center lg:text-left order-2 lg:order-1">
            <motion.h1 
              className="text-6xl lg:text-7xl xl:text-8xl font-bold leading-none text-balance"
            ...
            <motion.p 
              className="text-lg text-white max-w-md text-pretty"
            ...
            >
              <a href="#" className="inline-block">
                <motion.div 
                  className="bg-card border border-border rounded-lg px-4 py-2 flex items-center gap-2 hover:bg-card/80 transition-colors"
          ...
          <div className="flex justify-center items-end h-full pb-8 order-1 lg:order-2">
            <PhoneMockupTriple />
          </div>
        </div>
      </div>
